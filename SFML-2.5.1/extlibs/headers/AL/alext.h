...
#define AL_EXT_STATIC_BUFFER 1
    typedef ALvoid(
        AL_APIENTRY* PFNALBUFFERDATASTATICPROC)(const ALint, ALenum, ALvoid*, ALsizei, ALsizei);
#ifdef AL_ALEXT_PROTOTYPES
    AL_API ALvoid AL_APIENTRY
    alBufferDataStatic(const ALint buffer, ALenum format, ALvoid* data, ALsizei len, ALsizei freq);
#endif
#endif
...
#define AL_SAMPLE_RW_OFFSETS_SOFT 0x1032
    typedef ALvoid(
        AL_APIENTRY* PFNALBUFFERSUBDATASOFTPROC)(ALuint, ALenum, const ALvoid*, ALsizei, ALsizei);
#ifdef AL_ALEXT_PROTOTYPES
...
#define AL_SEC_LENGTH_SOFT 0x200B
    ...
    typedef void(AL_APIENTRY* LPALBUFFERSUBSAMPLESSOFT)(ALuint,
                                                        ...
                                                        const ALvoid*);
    typedef void(
        AL_APIENTRY* LPALGETBUFFERSAMPLESSOFT)(ALuint, ALsizei, ALsizei, ALenum, ALenum, ALvoid*);
...
#define AL_SEC_OFFSET_LATENCY_SOFT 0x1201
    ...
    typedef void(
        AL_APIENTRY* LPALSOURCE3I64SOFT)(ALuint, ALenum, ALint64SOFT, ALint64SOFT, ALint64SOFT);
