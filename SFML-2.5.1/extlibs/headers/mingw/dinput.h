...
DECLARE_INTERFACE_(IDirectInputDeviceA, IUnknown)
{
    ...
    (THIS_ LPDIENUMDEVICEOBJECTSCALLBACKA lpCallback, LPVOID pvRef, DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectInputDeviceW, IUnknown)
{
    ...
    STDMETHOD(GetCapabilities)(THIS_ LPDIDEVCAPS lpDIDevCaps) PURE;
    STDMETHOD(EnumObjects)
    (THIS_ LPDIENUMDEVICEOBJECTSCALLBACKW lpCallback, LPVOID pvRef, DWORD dwFlags) PURE;
    STDMETHOD(GetProperty)(THIS_ REFGUID rguidProp, LPDIPROPHEADER pdiph) PURE;
    STDMETHOD(SetProperty)(THIS_ REFGUID rguidProp, LPCDIPROPHEADER pdiph) PURE;
    STDMETHOD(Acquire)(THIS) PURE;
    STDMETHOD(Unacquire)(THIS) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice2A, IDirectInputDeviceA)
{
    ...
    (THIS_ REFGUID rguid, LPCDIEFFECT lpeff, LPDIRECTINPUTEFFECT * ppdeff, LPUNKNOWN punkOuter)
        PURE;
    STDMETHOD(EnumEffects)
    (THIS_ LPDIENUMEFFECTSCALLBACKA lpCallback, LPVOID pvRef, DWORD dwEffType) PURE;
    ...
    (THIS_ DWORD cbObjectData, LPCDIDEVICEOBJECTDATA rgdod, LPDWORD pdwInOut, DWORD fl) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice2W, IDirectInputDeviceW)
{
    ...
    (THIS_ REFGUID rguid, LPCDIEFFECT lpeff, LPDIRECTINPUTEFFECT * ppdeff, LPUNKNOWN punkOuter)
        PURE;
    STDMETHOD(EnumEffects)
    (THIS_ LPDIENUMEFFECTSCALLBACKW lpCallback, LPVOID pvRef, DWORD dwEffType) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W)
{
    ...
    STDMETHOD(EnumEffectsInFile)
    (THIS_ LPCWSTR lpszFileName, LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef, DWORD dwFlags)
        PURE;
    STDMETHOD(WriteEffectToFile)
...
DECLARE_INTERFACE_(IDirectInput7A, IDirectInput2A)
{
    ...
    (THIS_ REFGUID rguid, REFIID riid, LPVOID * pvOut, LPUNKNOWN lpUnknownOuter) PURE;
};
...
#else /* DI < 8 */
HRESULT WINAPI
DirectInputCreateA(HINSTANCE, DWORD, LPDIRECTINPUTA*, LPUNKNOWN);
HRESULT WINAPI
DirectInputCreateW(HINSTANCE, DWORD, LPDIRECTINPUTW*, LPUNKNOWN);
#define DirectInputCreate WINELIB_NAME_AW(DirectInputCreate)

HRESULT WINAPI
DirectInputCreateEx(HINSTANCE, DWORD, REFIID, LPVOID*, LPUNKNOWN);
#endif /* DI8 */
