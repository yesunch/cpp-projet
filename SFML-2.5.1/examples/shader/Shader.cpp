...
class Pixelate : public Effect
{
  public:
    ...
    void onUpdate(float, float x, float y) { m_shader.setUniform("pixel_threshold", (x + y) / 30); }
  ...
  public:
    ...
    bool onLoad()
    {
        ...
        m_text.setString(
            ...
            "Mauris mi odio, bibendum quis fringilla a, laoreet vel orci. Proin vitae vulputate "
            "tortor.\n"
            ...
            "In hac habitasse platea dictumst. Etiam fringilla est id odio dapibus sit amet semper "
            "dui laoreet.\n");
  ...
  public:
    ...
    bool onLoad()
    {
        ...
        if (!m_shader.loadFromFile(
                "resources/billboard.vert", "resources/billboard.geom", "resources/billboard.frag"))
            return false;
        m_shader.setUniform("texture", sf::Shader::CurrentTexture);
...
main()
{
    ...
    sf::RenderWindow window(
        sf::VideoMode(800, 600), "SFML Shader", sf::Style::Titlebar | sf::Style::Close);
