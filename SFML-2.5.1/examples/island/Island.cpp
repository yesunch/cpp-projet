...
threadFunction();
void
generateTerrain(sf::Vertex* vertexBuffer);
    ...
    while (window.isOpen())
    {
        ...
        if (prerequisitesSupported)
        {
            ...
            osstr << "Frame:  " << clock.restart().asMilliseconds() << "ms\n"
                  ...
                  << "Use the arrow keys to change the values.\nUse the return key to regenerate "
                     "the terrain.\n\n";
...
getElevation(float x, float y)
{
    ...
    {
        elevation += stb_perlin_noise3(x * perlinFrequency * std::pow(perlinFrequencyBase, i),
    ...
    elevation =
        (elevation + heightBase) * (1.0f - edgeFactor * std::pow(distance, edgeDropoffExponent));
...
////////////////////////////////////////////////////////////
sf::Color
getLowlandsTerrainColor(float moisture)
{
    sf::Color color =
        moisture < 0.27f
                  ...
                  : moisture < 0.4f
                        ...
                        : moisture < 0.48f
                              ...
                              : moisture < 0.6f
                                    ? sf::Color(0, 160, 0)
                                    : moisture < 0.7f
                                          ? sf::Color(34 * (moisture - 0.6f) / 0.1f,
...
////////////////////////////////////////////////////////////
sf::Color
getHighlandsTerrainColor(float elevation, float moisture)
{
...
////////////////////////////////////////////////////////////
sf::Color
getSnowcapTerrainColor(float elevation, float moisture)
{
...
////////////////////////////////////////////////////////////
sf::Color
getTerrainColor(float elevation, float moisture)
{
    sf::Color color =
        elevation < 0.11f
...
{
    sf::Vector3f deltaX(
        1, 0, (std::pow(right, heightFlatten) - std::pow(left, heightFlatten)) * heightFactor);
    sf::Vector3f deltaY(
        0, 1, (std::pow(top, heightFlatten) - std::pow(bottom, heightFlatten)) * heightFactor);
    ...
    for (unsigned int y = rowStart; y < rowEnd; y++)
    {
        for (int x = 0; x < resolutionX; x++)
        {
            ...
            else
            {
                ...
                vertices[arrayIndexBase + 0].texCoords = computeNormal(x,
                                                                       y,
                                                                       getElevation(x - 1, y),
                                                                       getElevation(x + 1, y),
                                                                       getElevation(x, y + 1),
            ...
            else
            {
                ...
                vertices[arrayIndexBase + 1].texCoords = computeNormal(x,
                                                                       y + 1,
            ...
            vertices[arrayIndexBase + 2].color =
                getTerrainColor(getElevation(x + 1, y + 1), getMoisture(x + 1, y + 1));
            vertices[arrayIndexBase + 2].texCoords = computeNormal(x + 1,
                                                                   y + 1,
                                                                   getElevation(x, y + 1),
            ...
            else
            {
                ...
                vertices[arrayIndexBase + 5].texCoords = computeNormal(x + 1,
                                                                       y,
                                                                       getElevation(x, y),
                                                                       getElevation(x + 2, y),
                                                                       getElevation(x + 1, y + 1),
...
////////////////////////////////////////////////////////////
void
generateTerrain(sf::Vertex* buffer)
{
