  ...
  : m_file(NULL)
{
    ...
    Lock(states->mutex);
    m_file =
        AAssetManager_open(states->activity->assetManager, filename.c_str(), AASSET_MODE_UNKNOWN);
}
...
////////////////////////////////////////////////////////////
Int64
ResourceStream::read(void* data, Int64 size)
{
    if (m_file)
    {
...
////////////////////////////////////////////////////////////
Int64
ResourceStream::seek(Int64 position)
{
    if (m_file)
    {
