...
{
size_t
read(void* ptr, size_t size, size_t nmemb, void* data)
{
...
int
seek(void* data, ogg_int64_t offset, int whence)
{
    sf::InputStream* stream = static_cast<sf::InputStream*>(data);
    switch (whence)
    {
...
////////////////////////////////////////////////////////////
bool
SoundFileReaderOgg::check(InputStream& stream)
{
    OggVorbis_File file;
...
////////////////////////////////////////////////////////////
bool
SoundFileReaderOgg::open(InputStream& stream, Info& info)
{
...
////////////////////////////////////////////////////////////
void
SoundFileReaderOgg::seek(Uint64 sampleOffset)
{
...
////////////////////////////////////////////////////////////
Uint64
SoundFileReaderOgg::read(Int16* samples, Uint64 maxCount)
{
    assert(m_vorbis.datasource);
    ...
    while (count < maxCount)
    {
        ...
        long bytesRead =
            ov_read(&m_vorbis, reinterpret_cast<char*>(samples), bytesToRead, 0, 2, 1, NULL);
        if (bytesRead > 0)
        {
