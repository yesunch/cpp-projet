...
////////////////////////////////////////////////////////////
bool
SoundBufferRecorder::onProcessSamples(const Int16* samples, std::size_t sampleCount)
{
...
{
    if (!m_samples.empty())
        m_buffer.loadFromSamples(
            &m_samples[0], m_samples.size(), getChannelCount(), getSampleRate());
}
