...
////////////////////////////////////////////////////////////
bool
SoundFileWriterOgg::check(const std::string& filename)
{
...
////////////////////////////////////////////////////////////
bool
SoundFileWriterOgg::open(const std::string& filename,
                         ...
                         unsigned int channelCount)
{
    ...
    if (status < 0)
    {
        err() << "Failed to write ogg/vorbis file \"" << filename << "\" (unsupported bitrate)"
              << std::endl;
        close();
        return false;
    }
    ...
    if (!m_file)
    {
        err() << "Failed to write ogg/vorbis file \"" << filename << "\" (cannot open file)"
              << std::endl;
        close();
        return false;
    }
    ...
    if (status < 0)
    {
        err() << "Failed to write ogg/vorbis file \"" << filename
              << "\" (cannot generate the headers)" << std::endl;
        close();
        return false;
    }
...
////////////////////////////////////////////////////////////
void
SoundFileWriterOgg::write(const Int16* samples, Uint64 count)
{
...
////////////////////////////////////////////////////////////
void
SoundFileWriterOgg::flushBlocks()
{
