...
void
encode(std::ostream& stream, sf::Int16 value)
{
...
void
encode(std::ostream& stream, sf::Uint16 value)
{
    unsigned char bytes[] = { static_cast<unsigned char>(value & 0xFF),
                              static_cast<unsigned char>(value >> 8) };
    stream.write(reinterpret_cast<const char*>(bytes), sizeof(bytes));
...
void
encode(std::ostream& stream, sf::Uint32 value)
{
    unsigned char bytes[] = {
...
////////////////////////////////////////////////////////////
bool
SoundFileWriterWav::check(const std::string& filename)
{
...
////////////////////////////////////////////////////////////
bool
SoundFileWriterWav::open(const std::string& filename,
...
////////////////////////////////////////////////////////////
void
SoundFileWriterWav::write(const Int16* samples, Uint64 count)
{
    assert(m_file.good());
...
////////////////////////////////////////////////////////////
bool
SoundFileWriterWav::writeHeader(unsigned int sampleRate, unsigned int channelCount)
{
    assert(m_file.good());
