...
////////////////////////////////////////////////////////////
bool
SoundFileWriterFlac::check(const std::string& filename)
{
...
////////////////////////////////////////////////////////////
bool
SoundFileWriterFlac::open(const std::string& filename,
                          ...
                          unsigned int channelCount)
{
    ...
    if (!m_encoder)
    {
        err() << "Failed to write flac file \"" << filename << "\" (failed to allocate encoder)"
              << std::endl;
        return false;
    }
    ...
    if (FLAC__stream_encoder_init_file(m_encoder, filename.c_str(), NULL, NULL) !=
        FLAC__STREAM_ENCODER_INIT_STATUS_OK)
    {
        err() << "Failed to write flac file \"" << filename << "\" (failed to open the file)"
              << std::endl;
        close();
        return false;
    }
...
////////////////////////////////////////////////////////////
void
SoundFileWriterFlac::write(const Int16* samples, Uint64 count)
{
    while (count > 0)
    {
