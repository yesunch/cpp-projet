  ...
  , GlResource
{
  ...
  private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool create(unsigned int width,
                        unsigned int height,
    ...
    std::map<Uint64, unsigned int>
        m_multisampleFrameBuffers; ///< Optional per-context OpenGL frame buffer objects with
                                   ///< multisample attachments
    unsigned int
        m_depthStencilBuffer;   ///< Optional depth/stencil buffer attached to the frame buffer
