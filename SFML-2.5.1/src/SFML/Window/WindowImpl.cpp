...
////////////////////////////////////////////////////////////
WindowImpl*
WindowImpl::create(VideoMode mode,
                   const String& title,
                   Uint32 style,
...
////////////////////////////////////////////////////////////
WindowImpl*
WindowImpl::create(WindowHandle handle)
{
...
////////////////////////////////////////////////////////////
void
WindowImpl::setJoystickThreshold(float threshold)
{
...
////////////////////////////////////////////////////////////
void
WindowImpl::processJoystickEvents()
{
        ...
        if (connected)
        {
            ...
            for (unsigned int j = 0; j < caps.buttonCount; ++j)
            {
                ...
                if (prevPressed ^ currPressed)
                {
                    Event event;
                    event.type =
                        currPressed ? Event::JoystickButtonPressed : Event::JoystickButtonReleased;
                    event.joystickButton.joystickId = i;
...
////////////////////////////////////////////////////////////
void
WindowImpl::processSensorEvents()
{
