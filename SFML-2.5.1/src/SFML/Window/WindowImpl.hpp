...
class WindowImpl : NonCopyable
{
  public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    static WindowImpl* create(VideoMode mode,
                              const String& title,
                              Uint32 style,
  ...
  private:
    ...
    float m_joystickThreshold; ///< Joystick threshold (minimum motion for "move" event to be
                               ///< generated)
    float m_previousAxes[Joystick::Count]
                        [Joystick::AxisCount]; ///< Position of each axis last time a move event
