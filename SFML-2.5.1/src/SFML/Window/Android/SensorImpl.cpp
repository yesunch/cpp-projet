...
SensorImpl::initialize()
{
    ...
    sensorEventQueue =
        ASensorManager_createEventQueue(sensorManager, looper, 1, &processSensorEvents, NULL);
}
...
////////////////////////////////////////////////////////////
bool
SensorImpl::isAvailable(Sensor::Type sensor)
{
...
////////////////////////////////////////////////////////////
bool
SensorImpl::open(Sensor::Type sensor)
{
...
////////////////////////////////////////////////////////////
void
SensorImpl::setEnabled(bool enabled)
{
    if (enabled)
...
////////////////////////////////////////////////////////////
ASensor const*
SensorImpl::getDefaultSensor(Sensor::Type sensor)
{
    // Find the Android sensor type
    static int types[] = { ASENSOR_TYPE_ACCELEROMETER,       ASENSOR_TYPE_GYROSCOPE,
                           ASENSOR_TYPE_MAGNETIC_FIELD,      ASENSOR_TYPE_GRAVITY,
                           ASENSOR_TYPE_LINEAR_ACCELERATION, ASENSOR_TYPE_ORIENTATION };
...
////////////////////////////////////////////////////////////
int
SensorImpl::processSensorEvents(int fd, int events, void* data)
{
    ASensorEvent event;
