...
////////////////////////////////////////////////////////////
WindowHandle
WindowImplAndroid::getSystemHandle() const
{
    ActivityStates* states = getActivity(NULL);
    Lock lock(states->mutex);
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::processEvents()
{
...
////////////////////////////////////////////////////////////
Vector2i
WindowImplAndroid::getPosition() const
{
    // Not applicable
    return Vector2i(0, 0);
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setPosition(const Vector2i& position)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
Vector2u
WindowImplAndroid::getSize() const
{
    return m_size;
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setSize(const Vector2u& size)
{
}

////////////////////////////////////////////////////////////
void
WindowImplAndroid::setTitle(const String& title)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setIcon(unsigned int width, unsigned int height, const Uint8* pixels)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setVisible(bool visible)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setMouseCursorVisible(bool visible)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setMouseCursorGrabbed(bool grabbed)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setMouseCursor(const CursorImpl& cursor)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::setKeyRepeatEnabled(bool enabled)
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::requestFocus()
{
    // Not applicable
}
...
////////////////////////////////////////////////////////////
bool
WindowImplAndroid::hasFocus() const
{
    return m_hasFocus;
}
...
////////////////////////////////////////////////////////////
void
WindowImplAndroid::forwardEvent(const Event& event)
{
    ActivityStates* states = getActivity(NULL);
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::processEvent(int fd, int events, void* data)
{
    ActivityStates* states = getActivity(NULL);
    Lock lock(states->mutex);
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::processScrollEvent(AInputEvent* _event, ActivityStates* states)
{
    ...
    jmethodID StaticMethodObtain = lJNIEnv->GetStaticMethodID(
        ClassMotionEvent, "obtain", "(JJIFFFFIFFII)Landroid/view/MotionEvent;");
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::processKeyEvent(AInputEvent* _event, ActivityStates* states)
{
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::processMotionEvent(AInputEvent* _event, ActivityStates* states)
{
    int32_t device = AInputEvent_getSource(_event);
    int32_t action = AMotionEvent_getAction(_event);
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::processPointerEvent(bool isDown, AInputEvent* _event, ActivityStates* states)
{
    int32_t device = AInputEvent_getSource(_event);
    int32_t action = AMotionEvent_getAction(_event);
...
////////////////////////////////////////////////////////////
Keyboard::Key
WindowImplAndroid::androidKeyToSF(int32_t key)
{
    switch (key)
    {
...
////////////////////////////////////////////////////////////
int
WindowImplAndroid::getUnicode(AInputEvent* event)
{
