...
class WindowImplWin32 : public WindowImpl
{
  ...
  private:
    ...
    HCURSOR m_lastCursor;    ///< Last cursor used -- this data is not owned by the window and is
    ...
    Uint16 m_surrogate;   ///< First half of the surrogate pair, in case we're receiving a Unicode
