...
static int
Load_EXT_swap_control(void)
{
    int numFailed = 0;
    sf_ptrc_wglGetSwapIntervalEXT =
        reinterpret_cast<int(CODEGEN_FUNCPTR*)(void)>(IntGetProcAddress("wglGetSwapIntervalEXT"));
    if (!sf_ptrc_wglGetSwapIntervalEXT)
        numFailed++;
    sf_ptrc_wglSwapIntervalEXT =
        reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(int)>(IntGetProcAddress("wglSwapIntervalEXT"));
    if (!sf_ptrc_wglSwapIntervalEXT)
        numFailed++;
    return numFailed;
}

BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglChoosePixelFormatARB)
(HDC, const int*, const FLOAT*, UINT, int*, UINT*) = NULL;
BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglGetPixelFormatAttribfvARB)
(HDC, int, int, UINT, const int*, FLOAT*) = NULL;
BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglGetPixelFormatAttribivARB)
(HDC, int, int, UINT, const int*, int*) = NULL;

static int
Load_ARB_pixel_format(void)
{
    int numFailed = 0;
    sf_ptrc_wglChoosePixelFormatARB =
        reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(HDC, const int*, const FLOAT*, UINT, int*, UINT*)>(
            IntGetProcAddress("wglChoosePixelFormatARB"));
    if (!sf_ptrc_wglChoosePixelFormatARB)
        numFailed++;
    sf_ptrc_wglGetPixelFormatAttribfvARB =
        reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(HDC, int, int, UINT, const int*, FLOAT*)>(
            IntGetProcAddress("wglGetPixelFormatAttribfvARB"));
    if (!sf_ptrc_wglGetPixelFormatAttribfvARB)
        numFailed++;
    sf_ptrc_wglGetPixelFormatAttribivARB =
        reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(HDC, int, int, UINT, const int*, int*)>(
            IntGetProcAddress("wglGetPixelFormatAttribivARB"));
...
Load_ARB_pbuffer()
{
    ...
    sf_ptrc_wglCreatePbufferARB =
        reinterpret_cast<HPBUFFERARB(CODEGEN_FUNCPTR*)(HDC, int, int, int, const int*)>(
            IntGetProcAddress("wglCreatePbufferARB"));
    if (!sf_ptrc_wglCreatePbufferARB)
        numFailed++;
    sf_ptrc_wglDestroyPbufferARB = reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(HPBUFFERARB)>(
        IntGetProcAddress("wglDestroyPbufferARB"));
    if (!sf_ptrc_wglDestroyPbufferARB)
        numFailed++;
    sf_ptrc_wglGetPbufferDCARB = reinterpret_cast<HDC(CODEGEN_FUNCPTR*)(HPBUFFERARB)>(
        IntGetProcAddress("wglGetPbufferDCARB"));
    if (!sf_ptrc_wglGetPbufferDCARB)
        numFailed++;
    sf_ptrc_wglQueryPbufferARB = reinterpret_cast<BOOL(CODEGEN_FUNCPTR*)(HPBUFFERARB, int, int*)>(
        IntGetProcAddress("wglQueryPbufferARB"));
    if (!sf_ptrc_wglQueryPbufferARB)
        numFailed++;
    sf_ptrc_wglReleasePbufferDCARB = reinterpret_cast<int(CODEGEN_FUNCPTR*)(HPBUFFERARB, HDC)>(
        IntGetProcAddress("wglReleasePbufferDCARB"));
...
static int
Load_ARB_create_context(void)
{
    int numFailed = 0;
    sf_ptrc_wglCreateContextAttribsARB =
        reinterpret_cast<HGLRC(CODEGEN_FUNCPTR*)(HDC, HGLRC, const int*)>(
            IntGetProcAddress("wglCreateContextAttribsARB"));
...
static sfwgl_StrToExtMap*
FindExtEntry(const char* extensionName)
{
...
static void
LoadExtByName(const char* extensionName)
{
...
static void
ProcExtsFromExtString(const char* strExtList)
{
    do
    {
...
int
sfwgl_LoadFunctions(HDC hdc)
{
    ClearExtensionVars();

    sf_ptrc_wglGetExtensionsStringARB = reinterpret_cast<const char*(CODEGEN_FUNCPTR*)(HDC)>(
        IntGetProcAddress("wglGetExtensionsStringARB"));
