...
#define WGL_ARB_pixel_format 1
    extern BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglChoosePixelFormatARB)(HDC,
                                                                  const int*,
                                                                  const FLOAT*,
                                                                  UINT,
                                                                  int*,
...
#define wglChoosePixelFormatARB sf_ptrc_wglChoosePixelFormatARB
    extern BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglGetPixelFormatAttribfvARB)(HDC,
                                                                       int,
                                                                       int,
                                                                       UINT,
                                                                       const int*,
...
#define wglGetPixelFormatAttribfvARB sf_ptrc_wglGetPixelFormatAttribfvARB
    extern BOOL(CODEGEN_FUNCPTR* sf_ptrc_wglGetPixelFormatAttribivARB)(HDC,
                                                                       int,
                                                                       int,
                                                                       UINT,
                                                                       const int*,
...
#define WGL_ARB_pbuffer 1
    extern HPBUFFERARB(
        CODEGEN_FUNCPTR* sf_ptrc_wglCreatePbufferARB)(HDC, int, int, int, const int*);
