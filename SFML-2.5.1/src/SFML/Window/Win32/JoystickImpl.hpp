...
class JoystickImpl
{
  ...
  private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    static BOOL CALLBACK deviceEnumerationCallback(const DIDEVICEINSTANCE* deviceInstance,
                                                   void* userData);
    ...
    deviceObjectEnumerationCallback(const DIDEVICEOBJECTINSTANCE* deviceObjectInstance,
                                    void* userData);
    ...
    int m_axes[Joystick::AxisCount]; ///< Offsets to the bytes containing the axes states, -1 if not
                                     ///< available
    int m_buttons[Joystick::ButtonCount]; ///< Offsets to the bytes containing the button states, -1
                                          ///< if not available
