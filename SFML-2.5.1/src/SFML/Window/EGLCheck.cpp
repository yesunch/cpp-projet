...
////////////////////////////////////////////////////////////
void
eglCheckError(const char* file, unsigned int line)
{
    ...
    if (errorCode != EGL_SUCCESS)
    {
        ...
        switch (errorCode)
        {
            case EGL_NOT_INITIALIZED:
            {
                ...
                description = "EGL is not initialized, or could not be initialized, for the "
                              "specified display";
                break;
            }
            ...
            case EGL_BAD_ACCESS:
            {
                ...
                description = "EGL cannot access a requested resource (for example, a context is "
            ...
            case EGL_BAD_CURRENT_SURFACE:
            {
                ...
                description = "the current surface of the calling thread is a window, pbuffer, or "
            ...
            case EGL_BAD_DISPLAY:
            {
                ...
                description = "an EGLDisplay argument does not name a valid EGLDisplay; or, EGL is "
                              "not initialized on the specified EGLDisplay";
                break;
            }
            ...
            case EGL_BAD_SURFACE:
            {
                ...
                description = "an EGLSurface argument does not name a valid surface (window, "
            ...
            case EGL_CONTEXT_LOST:
            {
                ...
                description =
                    ...
                    "contexts and reinitialize client API state and objects to continue rendering";
                break;
            }
        }
